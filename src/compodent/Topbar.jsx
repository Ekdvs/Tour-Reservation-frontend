        ...
        <div classNameName="row gx-0">
          <div classNameName="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
            <div classNameName="d-inline-flex align-items-center" style={{ height: '45px' }}>
              ...
              <a classNameName="btn btn-sm btn-outline-light btn-sm-square rounded-circle me-2" href="#">
              ...
              <a classNameName="btn btn-sm btn-outline-light btn-sm-square rounded-circle" href="#">
