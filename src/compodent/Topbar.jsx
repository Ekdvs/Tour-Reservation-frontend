                ...
                <div className="row gx-0">
                    ...
                    <div className="col-lg-4 text-center text-lg-end">
                        <div className="d-inline-flex align-items-center" style={{height: '45px'}}>
                            ...
                            <a href="/Login"><small className="me-3 text-light"><i
                                className="fa fa-sign-in-alt me-2"></i>Login</small></a>
                            <div className="dropdown">
                                ...
                                <div className="dropdown-menu rounded">
                                    <a href="/My_Profile" className="dropdown-item"><i
                                        className="fas fa-user-alt me-2"></i> My Profile</a>
                                    <a href="/" className="dropdown-item"><i
                                        className="fas fa-comment-alt me-2"></i> Inbox</a>
                                    <a href="/" className="dropdown-item"><i
                                        className="fas fa-bell me-2"></i> Notifications</a>
                                    <a href="/" className="dropdown-item"><i className="fas fa-cog me-2"></i> Account
                                        Settings</a>
                                    <a href="/" className="dropdown-item"><i className="fas fa-power-off me-2"></i> Log
                                        Out</a>
                                </div>
