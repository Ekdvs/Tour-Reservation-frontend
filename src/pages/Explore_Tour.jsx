                    ...
                    <div class="international-content">
                      <div class="international-info">
                        ...
                        <a href="#" class="btn-hover text-white me-4">
                          <i class="fas fa-map-marker-alt me-1"></i> 8 Cities
                        </a>
                        <a href="#" class="btn-hover text-white">
                  ...
                  <div class="international-item">
                    ...
                    <div class="international-content">
                      <div class="international-info">
                        ...
                        <a href="#" class="btn-hover text-white me-4">
                          <i class="fas fa-map-marker-alt me-1"></i> 12 Cities
                        </a>
                        <a href="#" class="btn-hover text-white">
                          <i class="fa fa-eye ms-2"></i>{" "}
                  ...
                  <div class="international-item">
                    ...
                    <div class="international-content">
                      ...
                      <div class="international-info">
                        ...
                        <a href="#" class="btn-hover text-white me-4">
                          <i class="fas fa-map-marker-alt me-1"></i> 9 Cities
                        </a>
                        <a href="#" class="btn-hover text-white">
                          <i class="fa fa-eye ms-2"></i>{" "}
                  ...
                  <div class="international-item">
                    ...
                    <div class="international-content">
                      ...
                      <div class="international-info">
                        ...
                        <a href="#" class="btn-hover text-white me-4">
                          <i class="fas fa-map-marker-alt me-1"></i> 17 Cities
                        </a>
                        <a href="#" class="btn-hover text-white">
                          <i class="fa fa-eye ms-2"></i>{" "}
