...
export default function Services() {
  return (
    <div>
      ...
      <div
        class="container-fluid bg-light service py-5"
        style={{
                  ...
                  <div class="service-content-inner d-flex  bg-white border border-primary rounded p-4 pe-4">
                    <div>
                      ...
                      <p className="text-justify" style={{ color: "black" }}>
                        Choose from a variety of tour packages designed to match
                        your interests. Whether you're into adventure, culture,
                        or relaxation, we’ve got something for you. From
                        thrilling activities to immersive cultural experiences,
                        each package includes accommodations, transportation,
                        and guided tours for a seamless trip. Start your journey
                        today with a package that fits your style.
                      </p>
                ...
                <div class="col-12">
                  <div class="service-content-inner d-flex  bg-white border border-primary rounded p-4 pe-4">
                    <div>
                      ...
                      <p className="text-justify" style={{ color: "black" }}>
                        Find your perfect home away from home with our range of
                        accommodations. Choose from luxurious hotels, relaxing
                        resorts, and unique stays, all designed to make your
                        trip unforgettable.
                      </p>
                  ...
                  <div class="service-content-inner d-flex  bg-white border border-primary rounded p-4 pe-4">
                    <div>
                      ...
                      <p className="text-justify" style={{ color: "black" }}>
                        ...
                        travel, we ensure you get to your destination
                ...
                <div class="col-12">
                  <div class="service-content-inner d-flex  bg-white border border-primary rounded p-4 pe-4">
                    <div>
                      ...
                      <p className="text-justify" style={{ color: "black" }}>
                        Our dedicated team is available 24/7 to assist you with
                        any questions or concerns. Reach out anytime through
                        phone, email, or chat for prompt and friendly support.
                      </p>
                      <b>Get Help Now</b>
                    </div>
                  </div>
                  ...
                  <div class="service-content-inner d-flex  bg-white border border-primary rounded p-4 pe-4">
                    <div>
                      ...
                      <p className="text-justify" style={{ color: "black" }}>
                        ...
                        needs, including credit cards, digital wallets, and easy
                        installment plans. Pay your way, stress-free.
                      </p>
